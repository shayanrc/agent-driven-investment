...
data_path, start, end, origin, horizon, seed)``. A repeat invocation of the
same key hits the cache and returns the previously written result; editing
the preset YAML or any input key invalidates.
