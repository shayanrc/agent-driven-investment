...
**Tally: sp wins lift on 11 of 12 cells**, only loses 40%/50d (nas 8.06× > sp 6.20×). sp wins AUC(t) on **10 of 12 cells** (loses 10%/50d where sp dropped to 0.400, and ties no cell).
