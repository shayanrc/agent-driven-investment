...
| Field | Type | Default |
|---|---|---|
| `candidates` | list[str], `"all"`, `"all_macro"`, `"all_fundamentals"`, `"all_fundamentals2"`, `"all_calendar2"`, `"all_fundamentals_calendar2"`, `"all_vwap"`, `"all_fundamentals_vwap"`, or `"all_fundamentals_vwap_calendar2"` | `"all"` (the full 279-col pool) |
| `exclude` | list[str] | `[]` |
