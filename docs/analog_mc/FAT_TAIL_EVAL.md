...
**Reproducible via** [`scripts/analog_mc/select_fat_tail_anchors.py`](../../scripts/analog_mc/select_fat_tail_anchors.py); persisted at [`results/analog_mc/data/fat_tail_eval_anchors.json`](../../results/analog_mc/data/fat_tail_eval_anchors.json).
...
uv run python scripts/analog_mc/select_fat_tail_anchors.py
