# gbdt experiment — russell1000_up_10pct_100d_dd5pct_aligned
...
- positive prevalence (eval): 0.488
...
|---|---|---|---|---|---|---|
| 0 | 279 | 0.2149 | 0.2409 | 0.0260 | iteration 0 — full feature pool, default HPs :: algorithmic fallback: kept 52/27 |  |
| 1 | 52 | 0.2134 | 0.2414 | 0.0280 | iteration 1 from FS+HP callback :: algorithmic fallback: kept 47/52 features; l2 |  |
| 2 | 47 | 0.2169 | 0.2431 | 0.0262 | iteration 2 from FS+HP callback :: inner_stop=plateau | plateau |
...
|---|---|---|---|---|---|
| eval | 0.2733 | 0.2499 | -0.0235 | 0.7428 | 0.5000 |
| test | 0.2338 | 0.2327 | -0.0011 | 0.6606 | 0.5002 |
...
### eval — n_rows=177800, base_rate=0.4878

Per-day:

| k | P@k | base_rate | n_picks | n_positives | n_denom | days_R<k / days_full_k / days_total |
|---|---|---|---|---|---|---|
| 1 | 0.4450 | 0.4878 | 200 | 89 | 200 | 0 / 200 / 200 |
| 5 | 0.3700 | 0.4878 | 1000 | 370 | 1000 | 0 / 200 / 200 |
| 10 | 0.4675 | 0.4878 | 2000 | 935 | 2000 | 0 / 200 / 200 |

Global (top-K across entire segment):

| k | P@k | base_rate | n_picks | n_positives | n_denom |
|---|---|---|---|---|---|
| 1 | 0.0000 | 0.4878 | 1 | 0 | 1 |
| 5 | 0.0000 | 0.4878 | 5 | 0 | 5 |
| 10 | 0.2000 | 0.4878 | 10 | 2 | 10 |

### test — n_rows=177800, base_rate=0.3683

Per-day:

| k | P@k | base_rate | n_picks | n_positives | n_denom | days_R<k / days_full_k / days_total |
|---|---|---|---|---|---|---|
| 1 | 0.4500 | 0.3683 | 200 | 90 | 200 | 0 / 200 / 200 |
| 5 | 0.3520 | 0.3683 | 1000 | 352 | 1000 | 0 / 200 / 200 |
| 10 | 0.3340 | 0.3683 | 2000 | 668 | 2000 | 0 / 200 / 200 |

Global (top-K across entire segment):

| k | P@k | base_rate | n_picks | n_positives | n_denom |
|---|---|---|---|---|---|
| 1 | 1.0000 | 0.3683 | 1 | 1 | 1 |
| 5 | 0.6000 | 0.3683 | 5 | 3 | 5 |
| 10 | 0.3000 | 0.3683 | 10 | 3 | 10 |
...
| ticker | n_picks | n_positives | hit_rate |
|---|---|---|---|
| NASDAQ:AAPL | 191 | 90 | 0.4712 |
| NASDAQ:ADBE | 189 | 48 | 0.2540 |
| NASDAQ:ADI | 187 | 50 | 0.2674 |
| NASDAQ:ADP | 186 | 75 | 0.4032 |
| NASDAQ:ADSK | 184 | 79 | 0.4293 |
| NASDAQ:MDLZ | 12 | 0 | 0.0000 |
| NYSE:CL | 12 | 0 | 0.0000 |
| NYSE:ATR | 6 | 1 | 0.1667 |
| NYSE:KO | 5 | 0 | 0.0000 |
| NYSE:ABT | 4 | 0 | 0.0000 |
...
|---|---|---|---|---|
| 2023Q4 | 290 | 130 | 0.4483 | 0.4878 |
| 2024Q1 | 305 | 64 | 0.2098 | 0.4878 |
| 2024Q2 | 315 | 155 | 0.4921 | 0.4878 |
| 2024Q3 | 90 | 21 | 0.2333 | 0.4878 |

### test

| quarter | n_picks | n_positives | P@5 | base_rate |
|---|---|---|---|---|
| 2024Q3 | 230 | 139 | 0.6043 | 0.3683 |
| 2024Q4 | 320 | 116 | 0.3625 | 0.3683 |
| 2025Q1 | 300 | 36 | 0.1200 | 0.3683 |
| 2025Q2 | 150 | 61 | 0.4067 | 0.3683 |
...
|---|---|---|---|---|---|---|
| eval | 177800 | 0.3345 | 0.3345 | 0.3345 | 0.0000 | `True` |
| test | 177800 | 0.3345 | 0.3731 | 0.3345 | 0.0013 | `True` |

## Per-experiment verdict (algorithmic readout)

Calibration: required isotonic (|z|=39.85); shipped as `isotonic`. Brier vs base-rate: -0.0235 (worse than baseline).
