# gbdt experiment — nifty500_up_50pct_200d_dd25pct_aligned
...
- positive prevalence (train): 0.272
- positive prevalence (eval): 0.478
...
|---|---|---|---|---|---|---|
| 0 | 279 | 0.0755 | 0.1809 | 0.1053 | iteration 0 — full feature pool, default HPs :: algorithmic fallback: kept 112/2 |  |
| 1 | 112 | 0.0756 | 0.1857 | 0.1101 | iteration 1 from FS+HP callback :: inner_stop=degradation | degradation |
...
|---|---|---|---|---|---|
| eval | 0.3594 | 0.2495 | -0.1098 | 1.0162 | 0.5142 |
| test | 0.2327 | 0.2059 | -0.0267 | 0.7007 | 0.4399 |
...
### eval — n_rows=71387, base_rate=0.4785

Per-day:

| k | P@k | base_rate | n_picks | n_positives | n_denom | days_R<k / days_full_k / days_total |
|---|---|---|---|---|---|---|
| 1 | 0.5250 | 0.4785 | 200 | 105 | 200 | 0 / 200 / 200 |
| 5 | 0.5620 | 0.4785 | 1000 | 562 | 1000 | 0 / 200 / 200 |
| 10 | 0.6010 | 0.4785 | 2000 | 1202 | 2000 | 0 / 200 / 200 |

Global (top-K across entire segment):

| k | P@k | base_rate | n_picks | n_positives | n_denom |
|---|---|---|---|---|---|
| 1 | 1.0000 | 0.4785 | 1 | 1 | 1 |
| 5 | 1.0000 | 0.4785 | 5 | 5 | 5 |
| 10 | 1.0000 | 0.4785 | 10 | 10 | 10 |

### test — n_rows=107804, base_rate=0.2901

Per-day:

| k | P@k | base_rate | n_picks | n_positives | n_denom | days_R<k / days_full_k / days_total |
|---|---|---|---|---|---|---|
| 1 | 0.3377 | 0.2901 | 302 | 102 | 302 | 0 / 302 / 302 |
| 5 | 0.3576 | 0.2901 | 1510 | 540 | 1510 | 0 / 302 / 302 |
| 10 | 0.3477 | 0.2901 | 3020 | 1050 | 3020 | 0 / 302 / 302 |

Global (top-K across entire segment):

| k | P@k | base_rate | n_picks | n_positives | n_denom |
|---|---|---|---|---|---|
| 1 | 0.0000 | 0.2901 | 1 | 0 | 1 |
| 5 | 0.0000 | 0.2901 | 5 | 0 | 5 |
| 10 | 0.2000 | 0.2901 | 10 | 2 | 10 |
...
|---|---|---|---|
| NSE:TARIL | 76 | 70 | 0.9211 |
| NSE:CHOLAHLDNG | 69 | 7 | 0.1014 |
| NSE:ADANIENSOL | 62 | 13 | 0.2097 |
| NSE:ENDURANCE | 38 | 12 | 0.3158 |
| NSE:FINCABLES | 37 | 37 | 1.0000 |
| NSE:CCL | 36 | 0 | 0.0000 |
| NSE:FACT | 34 | 34 | 1.0000 |
| NSE:KIRLOSENG | 34 | 33 | 0.9706 |
| NSE:NCC | 34 | 34 | 1.0000 |
| NSE:AMBUJACEM | 32 | 5 | 0.1562 |
...
|---|---|---|---|
| NSE:CCL | 36 | 0 | 0.0000 |
| NSE:BLUESTARCO | 23 | 0 | 0.0000 |
| NSE:CGCL | 17 | 0 | 0.0000 |
| NSE:KEC | 17 | 0 | 0.0000 |
| NSE:KPIL | 11 | 0 | 0.0000 |
...
| ticker | n_picks | n_positives | hit_rate |
|---|---|---|---|
| NSE:TARIL | 69 | 69 | 1.0000 |
| NSE:INOXWIND | 67 | 18 | 0.2687 |
| NSE:FACT | 63 | 28 | 0.4444 |
| NSE:SCHAEFFLER | 57 | 0 | 0.0000 |
| NSE:IRFC | 56 | 18 | 0.3214 |
| NSE:ASAHIINDIA | 54 | 0 | 0.0000 |
| NSE:BRIGADE | 51 | 22 | 0.4314 |
| NSE:ERIS | 51 | 1 | 0.0196 |
| NSE:IDEA | 51 | 7 | 0.1373 |
| NSE:RADICO | 48 | 14 | 0.2917 |
...
| NSE:SCHAEFFLER | 57 | 0 | 0.0000 |
| NSE:ASAHIINDIA | 54 | 0 | 0.0000 |
| NSE:JBCHEPHARM | 38 | 0 | 0.0000 |
| NSE:CARBORUNIV | 34 | 0 | 0.0000 |
| NSE:JUBLPHARMA | 26 | 0 | 0.0000 |
...
|---|---|---|---|---|
| 2022Q4 | 170 | 137 | 0.8059 | 0.4785 |
| 2023Q1 | 310 | 198 | 0.6387 | 0.4785 |
| 2023Q2 | 300 | 146 | 0.4867 | 0.4785 |
| 2023Q3 | 220 | 81 | 0.3682 | 0.4785 |

### test

| quarter | n_picks | n_positives | P@5 | base_rate |
|---|---|---|---|---|
| 2023Q3 | 95 | 56 | 0.5895 | 0.2901 |
| 2023Q4 | 305 | 210 | 0.6885 | 0.2901 |
| 2024Q1 | 310 | 131 | 0.4226 | 0.2901 |
| 2024Q2 | 305 | 99 | 0.3246 | 0.2901 |
| 2024Q3 | 320 | 41 | 0.1281 | 0.2901 |
| 2024Q4 | 175 | 3 | 0.0171 | 0.2901 |
...
|---|---|---|---|---|---|---|
| eval | 71387 | 0.0000 | 0.7757 | 0.1527 | 0.0608 | `False` |
| test | 107804 | 0.0000 | 0.5412 | 0.1469 | 0.0442 | `True` |

## Per-experiment verdict (algorithmic readout)

Calibration: required isotonic (|z|=74.59); shipped as `isotonic`. Brier vs base-rate: -0.1098 (worse than baseline).
