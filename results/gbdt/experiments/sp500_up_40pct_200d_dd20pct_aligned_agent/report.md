# gbdt experiment — sp500_up_40pct_200d_dd20pct_aligned_agent
...
|---|---|---|---|---|---|
| eval | 0.1368 | 0.1450 | +0.0082 | 0.4392 | 0.7064 |
| test | 0.1918 | 0.1710 | -0.0208 | 0.6971 | 0.6952 |
...
|---|---|---|---|---|---|---|
| 1 | 0.8950 | 0.1760 | 200 | 179 | 200 | 0 / 200 / 200 |
| 5 | 0.6280 | 0.1760 | 1000 | 628 | 1000 | 0 / 200 / 200 |
...
| k | P@k | base_rate | n_picks | n_positives | n_denom | days_R<k / days_full_k / days_total |
|---|---|---|---|---|---|---|
| 1 | 0.6967 | 0.2189 | 300 | 209 | 300 | 0 / 300 / 300 |
| 5 | 0.4287 | 0.2189 | 1500 | 643 | 1500 | 0 / 300 / 300 |
| 10 | 0.4447 | 0.2189 | 3000 | 1334 | 3000 | 0 / 300 / 300 |
...
| 3 | 0.4678 | 0.2189 | 300 |
| 5 | 0.4287 | 0.2189 | 300 |
| 10 | 0.4447 | 0.2189 | 300 |
| 20 | 0.4663 | 0.2189 | 300 |
...
|---|---|---|---|
| NASDAQ:TTD | 110 | 69 | 0.6273 |
| NYSE:NCLH | 95 | 64 | 0.6737 |
| NASDAQ:TSLA | 92 | 53 | 0.5761 |
| NYSE:CVNA | 89 | 65 | 0.7303 |
| NYSE:CCL | 78 | 62 | 0.7949 |
| NASDAQ:AMD | 72 | 72 | 1.0000 |
| NASDAQ:META | 68 | 61 | 0.8971 |
| NYSE:XYZ | 66 | 4 | 0.0606 |
| NASDAQ:WBD | 64 | 1 | 0.0156 |
| NASDAQ:NVDA | 54 | 52 | 0.9630 |

Bottom-5 by hit_rate (n_picks ≥ 5):

| ticker | n_picks | n_positives | hit_rate |
|---|---|---|---|
| NYSE:COHR | 23 | 0 | 0.0000 |
| NYSE:APA | 10 | 0 | 0.0000 |
| NASDAQ:DXCM | 9 | 0 | 0.0000 |
| NASDAQ:LULU | 9 | 0 | 0.0000 |
...
| NYSE:SMCI | 298 | 131 | 0.4396 |
| NYSE:PSKY | 215 | 13 | 0.0605 |
| NASDAQ:TSLA | 124 | 9 | 0.0726 |
| NYSE:COHR | 112 | 84 | 0.7500 |
| NYSE:ALB | 85 | 7 | 0.0824 |
| NASDAQ:WBD | 84 | 27 | 0.3214 |
| NYSE:SATS | 57 | 42 | 0.7368 |
| NASDAQ:TTD | 45 | 19 | 0.4222 |
| NYSE:DELL | 32 | 10 | 0.3125 |

Bottom-5 by hit_rate (n_picks ≥ 5):

| ticker | n_picks | n_positives | hit_rate |
|---|---|---|---|
| NYSE:XYZ | 21 | 0 | 0.0000 |
| NYSE:PSKY | 215 | 13 | 0.0605 |
| NASDAQ:TSLA | 124 | 9 | 0.0726 |
| NYSE:ALB | 85 | 7 | 0.0824 |
| NYSE:GNRC | 24 | 7 | 0.2917 |
...
|---|---|---|---|---|
| 2022Q4 | 295 | 236 | 0.8000 | 0.1760 |
| 2023Q1 | 310 | 201 | 0.6484 | 0.1760 |
| 2023Q2 | 310 | 180 | 0.5806 | 0.1760 |
| 2023Q3 | 85 | 11 | 0.1294 | 0.1760 |

### test

| quarter | n_picks | n_positives | P@5 | base_rate |
|---|---|---|---|---|
| 2023Q3 | 230 | 56 | 0.2435 | 0.2189 |
| 2023Q4 | 315 | 180 | 0.5714 | 0.2189 |
| 2024Q1 | 305 | 147 | 0.4820 | 0.2189 |
| 2024Q2 | 315 | 138 | 0.4381 | 0.2189 |
| 2024Q3 | 320 | 118 | 0.3688 | 0.2189 |
| 2024Q4 | 15 | 4 | 0.2667 | 0.2189 |
...
|---|---|---|---|---|---|---|
| eval | 95400 | 0.0000 | 1.0000 | 0.1185 | 0.0799 | `False` |
| test | 143100 | 0.0000 | 0.3433 | 0.0507 | 0.0409 | `True` |

## Per-experiment verdict (algorithmic readout)

Calibration: required isotonic (|z|=65.82); shipped as `isotonic`. Brier vs base-rate: +0.0082 (model beats baseline).
