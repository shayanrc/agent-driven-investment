# gbdt experiment — nifty500_up_10pct_10d_dd5pct_aligned
...
- positive prevalence (eval): 0.167
...
|---|---|---|---|---|---|---|
| 0 | 279 | 0.0907 | 0.1116 | 0.0209 | iteration 0 — full feature pool, default HPs :: algorithmic fallback: kept 224/2 |  |
| 1 | 224 | 0.0907 | 0.1116 | 0.0209 | iteration 1 from FS+HP callback :: algorithmic fallback: kept 224/224 features;  |  |
| 2 | 224 | 0.0907 | 0.1116 | 0.0209 | iteration 2 from FS+HP callback :: inner_stop=plateau | plateau |
...
|---|---|---|---|---|---|
| eval | 0.1404 | 0.1392 | -0.0012 | 0.4678 | 0.6240 |
| test | 0.0830 | 0.0844 | +0.0014 | 0.3009 | 0.6746 |
...
### eval — n_rows=75907, base_rate=0.1671

Per-day:

| k | P@k | base_rate | n_picks | n_positives | n_denom | days_R<k / days_full_k / days_total |
|---|---|---|---|---|---|---|
| 1 | 0.2277 | 0.1671 | 202 | 46 | 202 | 0 / 202 / 202 |
| 5 | 0.2426 | 0.1671 | 1010 | 245 | 1010 | 0 / 202 / 202 |
| 10 | 0.2547 | 0.1671 | 2020 | 513 | 2014 | 4 / 202 / 202 |

Global (top-K across entire segment):

| k | P@k | base_rate | n_picks | n_positives | n_denom |
|---|---|---|---|---|---|
| 1 | 0.0000 | 0.1671 | 1 | 0 | 1 |
| 5 | 0.2000 | 0.1671 | 5 | 1 | 5 |
| 10 | 0.1000 | 0.1671 | 10 | 1 | 10 |

### test — n_rows=37600, base_rate=0.0930

Per-day:

| k | P@k | base_rate | n_picks | n_positives | n_denom | days_R<k / days_full_k / days_total |
|---|---|---|---|---|---|---|
| 1 | 0.3400 | 0.0930 | 100 | 34 | 100 | 0 / 100 / 100 |
| 5 | 0.2240 | 0.0930 | 500 | 112 | 500 | 0 / 100 / 100 |
| 10 | 0.2006 | 0.0930 | 1000 | 195 | 972 | 11 / 100 / 100 |

Global (top-K across entire segment):

| k | P@k | base_rate | n_picks | n_positives | n_denom |
|---|---|---|---|---|---|
| 1 | 1.0000 | 0.0930 | 1 | 1 | 1 |
| 5 | 0.4000 | 0.0930 | 5 | 2 | 5 |
| 10 | 0.4000 | 0.0930 | 10 | 4 | 10 |
...
|---|---|---|---|
| NSE:GVT&D | 52 | 18 | 0.3462 |
| NSE:SONATSOFTW | 48 | 0 | 0.0000 |
| NSE:GALLANTT | 31 | 10 | 0.3226 |
| NSE:IREDA | 31 | 11 | 0.3548 |
| NSE:CGCL | 30 | 10 | 0.3333 |
| NSE:INOXWIND | 28 | 10 | 0.3571 |
| NSE:ZEEL | 28 | 9 | 0.3214 |
| NSE:IIFL | 26 | 4 | 0.1538 |
| NSE:RVNL | 26 | 5 | 0.1923 |
| NSE:MMTC | 24 | 5 | 0.2083 |
...
|---|---|---|---|
| NSE:SONATSOFTW | 48 | 0 | 0.0000 |
| NSE:ASTERDM | 19 | 0 | 0.0000 |
| NSE:HUDCO | 12 | 0 | 0.0000 |
| NSE:CIEINDIA | 10 | 0 | 0.0000 |
| NSE:SARDAEN | 10 | 0 | 0.0000 |
...
| ticker | n_picks | n_positives | hit_rate |
|---|---|---|---|
| NSE:TARIL | 36 | 17 | 0.4722 |
| NSE:COCHINSHIP | 33 | 7 | 0.2121 |
| NSE:IDEA | 28 | 4 | 0.1429 |
| NSE:RPOWER | 24 | 14 | 0.5833 |
| NSE:GALLANTT | 19 | 1 | 0.0526 |
| NSE:GVT&D | 19 | 3 | 0.1579 |
| NSE:360ONE | 17 | 0 | 0.0000 |
| NSE:PCBL | 17 | 5 | 0.2941 |
| NSE:CEMPRO | 13 | 0 | 0.0000 |
| NSE:ITI | 13 | 3 | 0.2308 |
...
|---|---|---|---|---|
| 2023Q4 | 170 | 49 | 0.2882 | 0.1671 |
| 2024Q1 | 310 | 76 | 0.2452 | 0.1671 |
| 2024Q2 | 305 | 78 | 0.2557 | 0.1671 |
| 2024Q3 | 225 | 42 | 0.1867 | 0.1671 |

### test

| quarter | n_picks | n_positives | P@5 | base_rate |
|---|---|---|---|---|
| 2024Q3 | 95 | 24 | 0.2526 | 0.0930 |
| 2024Q4 | 310 | 77 | 0.2484 | 0.0930 |
| 2025Q1 | 95 | 11 | 0.1158 | 0.0930 |
...
|---|---|---|---|---|---|---|
| eval | 75907 | 0.0000 | 0.6000 | 0.0988 | 0.0506 | `False` |
| test | 37600 | 0.0000 | 0.4407 | 0.1256 | 0.0450 | `True` |

## Per-experiment verdict (algorithmic readout)

Calibration: required isotonic (|z|=58.66); shipped as `isotonic`. Brier vs base-rate: -0.0012 (worse than baseline).
